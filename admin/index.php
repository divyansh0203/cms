...
--->
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="st_batch"  class="form-control" id="input1" placeholder="batch e.x 2016" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="st_sem"  class="form-control" id="input1" placeholder="semester ex. 8" />
          </div>
      </div>
      ...
      <input type="submit" class="btn btn-primary col-md-3 col-md-offset-7" value="Add Student" name="std" />
    </form>
...
-->
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="tc_course"  class="form-control" id="input1" placeholder="course ex. Internet Of Things" />
          </div>
      </div>

      <input type="submit" class="btn btn-primary col-md-3 col-md-offset-7" value="Add Teacher" name="tcr" />
    </form>
