...
mysqli_query($con,"SELECT * FROM admininfo");
...
#        $result = mysqli_query("insert into admininfo(username,password,email,fname,phone,type) values('$_POST[uname]','$_POST[pass]','$_POST[email]','$_POST[fname]','$_POST[phone]','$_POST[type]')");
...
<header>
  ...
  <h2>Online Attendance Management System</h2>
  ...
  <div class="row">
    ...
    <form method="post" class="form-horizontal col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="pass"  class="form-control" id="input1" placeholder="choose a strong password" />
          </div>
      </div>
...
<!--
//un-comment these lines to display admin and teachers role at signup page//
            <label>
